...
const iconMap = {
  'IconAbnormal': IconAbnormal,
  'IconAdd': IconAdd,
  'IconAddPerson': IconAddPerson,
  'IconAlert': IconAlert,
  'IconAllergy': IconAllergy,
  ...
  'IconCompose': IconCompose,
  'IconCritical': IconCritical,
  'IconDevice': IconDevice,
  'IconDeviceAlert': IconDeviceAlert,
  'IconDeviceCheck': IconDeviceCheck,
  'IconDiamond': IconDiamond,
  'IconDocuments': IconDocuments,
  'IconDoNotDisturb': IconDoNotDisturb,
  'IconDoorOpen': IconDoorOpen,
  'IconDown': IconDown,
  'IconDownload': IconDownload,
  'IconDue': IconDue,
  'IconDueSoon': IconDueSoon,
  'IconEdit': IconEdit,
  'IconEllipses': IconEllipses,
  'IconEnvelope': IconEnvelope,
  'IconError': IconError,
  'IconExclamation': IconExclamation,
  'IconExpandLess': IconExpandLess,
  'IconExpandMore': IconExpandMore,
  'IconFeatured': IconFeatured,
  'IconFeaturedOff': IconFeaturedOff,
  'IconFeaturedOutline': IconFeaturedOutline,
  'IconFirst': IconFirst,
  'IconFlag': IconFlag,
  'IconFlowsheet': IconFlowsheet,
  'IconFolder': IconFolder,
  'IconForward': IconForward,
  'IconFunnel': IconFunnel,
  'IconGapChecking': IconGapChecking,
  'IconGlasses': IconGlasses,
  'IconHelp': IconHelp,
  'IconHelpInverse': IconHelpInverse,
  'IconHigh': IconHigh,
  'IconHighPriority': IconHighPriority,
  'IconHospital': IconHospital,
  'IconHouse': IconHouse,
  'IconImage': IconImage,
  'IconImplant': IconImplant,
  'IconIncomingCall': IconIncomingCall,
  'IconIncomplete': IconIncomplete,
  'IconInformation': IconInformation,
  'IconInformationInverse': IconInformationInverse,
  'IconIPass': IconIPass,
  'IconItalicI': IconItalicI,
  'IconKnurling': IconKnurling,
  'IconLast': IconLast,
  'IconLeft': IconLeft,
  'IconLeftPane': IconLeftPane,
  'IconLightbulb': IconLightbulb,
  'IconLink': IconLink,
  'IconList': IconList,
  'IconLookback': IconLookback,
  'IconLow': IconLow,
  'IconMax': IconMax,
  ...
  'IconMicrophoneDisabled': IconMicrophoneDisabled,
  'IconMin': IconMin,
  'IconMinimize': IconMinimize,
  'IconMinus': IconMinus,
  'IconMissedCall': IconMissedCall,
  'IconModified': IconModified,
  'IconNext': IconNext,
  'IconNoSignal': IconNoSignal,
  'IconNotification': IconNotification,
  'IconNotificationOff': IconNotificationOff,
  'IconNotMet': IconNotMet,
  'IconOutgoingCall': IconOutgoingCall,
  'IconOverDue': IconOverDue,
  'IconPadlock': IconPadlock,
  'IconPanelLeft': IconPanelLeft,
  'IconPanelRight': IconPanelRight,
  'IconPaperFolded': IconPaperFolded,
  'IconPaperPencil': IconPaperPencil,
  'IconPause': IconPause,
  'IconPending': IconPending,
  'IconPerson': IconPerson,
  'IconPersonHospital': IconPersonHospital,
  'IconPersonnelPerson': IconPersonnelPerson,
  'IconPharmacyReject': IconPharmacyReject,
  'IconPharmacyReview': IconPharmacyReview,
  'IconPhone': IconPhone,
  'IconPhoneDown': IconPhoneDown,
  'IconPill': IconPill,
  'IconPinDiagonal': IconPinDiagonal,
  'IconPinDown': IconPinDown,
  ...
  'IconQuestionOutline': IconQuestionOutline,
  'IconRecurringEvent': IconRecurringEvent,
  'IconRefresh': IconRefresh,
  'IconReload': IconReload,
  'IconReply': IconReply,
  'IconReplyAll': IconReplyAll,
  'IconRequired': IconRequired,
  'IconRight': IconRight,
  'IconSave': IconSave,
  'IconScheduled': IconScheduled,
  'IconScratchPad': IconScratchPad,
  ...
  'IconSuccessInverse': IconSuccessInverse,
  'IconSwap': IconSwap,
  'IconTable': IconTable,
  'IconTag': IconTag,
  'IconTile': IconTile,
  'IconTrash': IconTrash,
  'IconTreemap': IconTreemap,
  'IconTrophy': IconTrophy,
  'IconUnavailable': IconUnavailable,
  'IconUnexpected': IconUnexpected,
  'IconUnknown': IconUnknown,
  'IconUnlock': IconUnlock,
  'IconUnread': IconUnread,
  'IconUnspecified': IconUnspecified,
  'IconUp': IconUp,
  'IconUpload': IconUpload,
  'IconUsers': IconUsers,
  'IconVideoCamera': IconVideoCamera,
  'IconVideoCameraDisabled': IconVideoCameraDisabled,
  'IconVisualization': IconVisualization,
